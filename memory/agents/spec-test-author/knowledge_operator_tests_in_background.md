...
**Why:** 2026-08-14 の Solidify 機能（`memory/specs/solidify.md` AC-30〜AC-37 / AC-42）で `tests/silicone_molding/operators/` と tier 2 を書いたときに確認した。1 と 3 はテストが常に緑になる（＝何も検証していない）タイプの罠なので特に危険。
