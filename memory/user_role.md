---
name: user_role
description: ユーザーは日本語でやり取りし、Blender / 3D プリント / シリコーン造形の実務ドメイン知識を持つ
type: user
---

ユーザー (Geson-anko) は日本語でやり取りする。Blender の操作、3D プリント、シリコーン造形のドメイン知識を実務レベルで持っており、造形上の用語（分割面、抜き勾配、湯口、インターロック等）は説明なしで通じる。
